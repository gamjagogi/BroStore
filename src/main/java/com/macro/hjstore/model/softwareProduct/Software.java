...
public class Software {
    ...
    @Builder
    public Software(Long id, String thumbnail, String name, String img, Integer price, Integer originPrice, Integer discountPrice, Integer discountPercentage, boolean isNew, boolean isHot, Integer star, boolean isFreeShipping,String highlights ,String description, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
